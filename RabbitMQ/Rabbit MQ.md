...
- `Consumer`: producer로부터 메세지를 받아 처리하는 주체이다.
...
- `Queue` : consumer가 메세지를 consume하기 전까지 보관하는 장소이다.
![image](https://user-images.githubusercontent.com/31242766/203731587-754712b8-e8fb-44b1-b74d-bb1c3489ca1f.png)
  - Name: Queue 이름, amq.은 예약어로써 사용 불가
  - Durability: 브로커가 재시작될 때 남아있는지 여부
    - Durable: 브로커가 재시작되어도 디스크에 저장되어 남아있음
    - Transient: 브로커가 재시작되면 사라짐
  - Auto delete: 마지막 Consumer가 consume을 끝낼 경우 자동 삭제
  - Argument: Message TTL, Max Length bytes 같은 추가 기능 명시

## Prefetch Count
![image](https://user-images.githubusercontent.com/31242766/203732504-6769abbe-ca71-4d87-9580-068fa9850b69.png)
